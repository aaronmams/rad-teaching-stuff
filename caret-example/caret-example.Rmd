...
Make the target variable a factor rather than [0,1]...many of the ML libraries in R don't like numeric target variable for two-class prediction problems.
...
There are plenty of model diagnostic methods available in caret.  [See Chapters 15 and 18-22](https://topepo.github.io/caret/variable-importance.html).  I'm just going to a quick demo of two:
